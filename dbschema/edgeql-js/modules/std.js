...
exports.FreeObject = exports.$FreeObject = exports.Object_988c9d98355811ed91ab93b70794e9cf = exports.$Object_988c9d98355811ed91ab93b70794e9cf = exports.BaseObject = exports.$BaseObject = exports.number = exports.uuid = exports.str = exports.$sequence = exports.json = exports.int64 = exports.int32 = exports.int16 = exports.float64 = exports.float32 = exports.duration = exports.decimal = exports.datetime = exports.bytes = exports.bool = exports.bigint = exports.JsonEmpty = void 0;
const edgedb_1 = require("edgedb");
const _ = __importStar(require("../imports"));
const JsonEmpty = edgedb_1.$.makeType(_.spec, "97c724a0-3558-11ed-9ce8-ddfdaaecbbd3", _.syntax.literal);
exports.JsonEmpty = JsonEmpty;
const bigint = edgedb_1.$.makeType(_.spec, "00000000-0000-0000-0000-000000000110", _.syntax.literal);
exports.bigint = bigint;
const bool = edgedb_1.$.makeType(_.spec, "00000000-0000-0000-0000-000000000109", _.syntax.literal);
exports.bool = bool;
const bytes = edgedb_1.$.makeType(_.spec, "00000000-0000-0000-0000-000000000102", _.syntax.literal);
exports.bytes = bytes;
const datetime = edgedb_1.$.makeType(_.spec, "00000000-0000-0000-0000-00000000010a", _.syntax.literal);
exports.datetime = datetime;
const decimal = edgedb_1.$.makeType(_.spec, "00000000-0000-0000-0000-000000000108", _.syntax.literal);
exports.decimal = decimal;
const duration = edgedb_1.$.makeType(_.spec, "00000000-0000-0000-0000-00000000010e", _.syntax.literal);
exports.duration = duration;
const float32 = edgedb_1.$.makeType(_.spec, "00000000-0000-0000-0000-000000000106", _.syntax.literal);
exports.float32 = float32;
const float64 = edgedb_1.$.makeType(_.spec, "00000000-0000-0000-0000-000000000107", _.syntax.literal);
exports.float64 = float64;
const int16 = edgedb_1.$.makeType(_.spec, "00000000-0000-0000-0000-000000000103", _.syntax.literal);
exports.int16 = int16;
const int32 = edgedb_1.$.makeType(_.spec, "00000000-0000-0000-0000-000000000104", _.syntax.literal);
exports.int32 = int32;
const int64 = edgedb_1.$.makeType(_.spec, "00000000-0000-0000-0000-000000000105", _.syntax.literal);
exports.int64 = int64;
const json = edgedb_1.$.makeType(_.spec, "00000000-0000-0000-0000-00000000010f", _.syntax.literal);
exports.json = json;
const $sequence = edgedb_1.$.makeType(_.spec, "950502b4-3558-11ed-9fbe-f9bdd9ccd057", _.syntax.literal);
exports.$sequence = $sequence;
const str = edgedb_1.$.makeType(_.spec, "00000000-0000-0000-0000-000000000101", _.syntax.literal);
exports.str = str;
const uuid = edgedb_1.$.makeType(_.spec, "00000000-0000-0000-0000-000000000100", _.syntax.literal);
exports.uuid = uuid;
const number = edgedb_1.$.makeType(_.spec, "00000000-0000-0000-0000-0000000001ff", _.syntax.literal);
exports.number = number;
const $BaseObject = edgedb_1.$.makeType(_.spec, "9889cdca-3558-11ed-98dc-61a41206224c", _.syntax.literal);
exports.$BaseObject = $BaseObject;
const BaseObject = _.syntax.$PathNode(edgedb_1.$.$toSet($BaseObject, edgedb_1.$.Cardinality.Many), null, true);
exports.BaseObject = BaseObject;
const $Object_988c9d98355811ed91ab93b70794e9cf = edgedb_1.$.makeType(_.spec, "988c9d98-3558-11ed-91ab-93b70794e9cf", _.syntax.literal);
exports.$Object_988c9d98355811ed91ab93b70794e9cf = $Object_988c9d98355811ed91ab93b70794e9cf;
const Object_988c9d98355811ed91ab93b70794e9cf = _.syntax.$PathNode(edgedb_1.$.$toSet($Object_988c9d98355811ed91ab93b70794e9cf, edgedb_1.$.Cardinality.Many), null, true);
exports.Object_988c9d98355811ed91ab93b70794e9cf = Object_988c9d98355811ed91ab93b70794e9cf;
const $FreeObject = edgedb_1.$.makeType(_.spec, "988fe3b8-3558-11ed-96e0-89341882dfe9", _.syntax.literal);
exports.$FreeObject = $FreeObject;
const FreeObject = _.syntax.$PathNode(edgedb_1.$.$toSet($FreeObject, edgedb_1.$.Cardinality.One), null, true);
exports.FreeObject = FreeObject;
...
function min(...args) {
    const { returnType, cardinality, args: positionalArgs, namedArgs } = _.syntax.$resolveOverload('std::min', args, _.spec, [
        { args: [{ typeId: "950143a4-3558-11ed-ab16-f5d1f6ca8e54", optional: false, setoftype: true, variadic: false }], returnTypeId: "950143a4-3558-11ed-ab16-f5d1f6ca8e54", returnTypemod: "OptionalType", preservesOptionality: true },
        { args: [{ typeId: "95055b2e-3558-11ed-9afc-8374ce1e20a1", optional: false, setoftype: true, variadic: false }], returnTypeId: "95055b2e-3558-11ed-9afc-8374ce1e20a1", returnTypemod: "OptionalType", preservesOptionality: true },
...
function contains(...args) {
    const { returnType, cardinality, args: positionalArgs, namedArgs } = _.syntax.$resolveOverload('std::contains', args, _.spec, [
        ...
        { args: [{ typeId: "470994fd-eaa3-2aec-6dba-5e3af68929fb", optional: false, setoftype: false, variadic: false }, { typeId: "470994fd-eaa3-2aec-6dba-5e3af68929fb", optional: false, setoftype: false, variadic: false }], returnTypeId: "00000000-0000-0000-0000-000000000109" },
        { args: [{ typeId: "470994fd-eaa3-2aec-6dba-5e3af68929fb", optional: false, setoftype: false, variadic: false }, { typeId: "94fdfe92-3558-11ed-8b28-7b741495b3cb", optional: false, setoftype: false, variadic: false }], returnTypeId: "00000000-0000-0000-0000-000000000109" },
...
function range_is_empty(...args) {
    const { returnType, cardinality, args: positionalArgs, namedArgs } = _.syntax.$resolveOverload('std::range_is_empty', args, _.spec, [
        { args: [{ typeId: "470994fd-eaa3-2aec-6dba-5e3af68929fb", optional: false, setoftype: false, variadic: false }], returnTypeId: "00000000-0000-0000-0000-000000000109" },
    ]);
    return _.syntax.$expressionify({
        __kind__: edgedb_1.$.ExpressionKind.Function,
        __element__: returnType,
...
function range_get_upper(...args) {
    const { returnType, cardinality, args: positionalArgs, namedArgs } = _.syntax.$resolveOverload('std::range_get_upper', args, _.spec, [
        { args: [{ typeId: "470994fd-eaa3-2aec-6dba-5e3af68929fb", optional: false, setoftype: false, variadic: false }], returnTypeId: "94fdfe92-3558-11ed-8b28-7b741495b3cb", returnTypemod: "OptionalType" },
    ]);
    return _.syntax.$expressionify({
        __kind__: edgedb_1.$.ExpressionKind.Function,
        __element__: returnType,
...
function sequence_reset(...args) {
    const { returnType, cardinality, args: positionalArgs, namedArgs } = _.syntax.$resolveOverload('std::sequence_reset', args, _.spec, [
        { args: [{ typeId: "9a341fc2-3558-11ed-8a65-9d626b789158", optional: false, setoftype: false, variadic: false }], returnTypeId: "00000000-0000-0000-0000-0000000001ff" },
        { args: [{ typeId: "9a341fc2-3558-11ed-8a65-9d626b789158", optional: false, setoftype: false, variadic: false }, { typeId: "00000000-0000-0000-0000-0000000001ff", optional: false, setoftype: false, variadic: false }], returnTypeId: "00000000-0000-0000-0000-0000000001ff" },
    ]);
    return _.syntax.$expressionify({
        __kind__: edgedb_1.$.ExpressionKind.Function,
        __element__: returnType,
...
const __defaultExports = {
    ...
    "Object": Object_988c9d98355811ed91ab93b70794e9cf,
