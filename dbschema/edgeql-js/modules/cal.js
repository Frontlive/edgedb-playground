...
const date_duration = edgedb_1.$.makeType(_.spec, "00000000-0000-0000-0000-000000000112", _.syntax.literal);
exports.date_duration = date_duration;
const local_date = edgedb_1.$.makeType(_.spec, "00000000-0000-0000-0000-00000000010c", _.syntax.literal);
exports.local_date = local_date;
const local_datetime = edgedb_1.$.makeType(_.spec, "00000000-0000-0000-0000-00000000010b", _.syntax.literal);
exports.local_datetime = local_datetime;
const local_time = edgedb_1.$.makeType(_.spec, "00000000-0000-0000-0000-00000000010d", _.syntax.literal);
exports.local_time = local_time;
const relative_duration = edgedb_1.$.makeType(_.spec, "00000000-0000-0000-0000-000000000111", _.syntax.literal);
